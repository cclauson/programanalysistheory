...
It turns out to be true that the semantic space for Branch Back Program Formulas and Program Control Graphs are identical.  To prove this, we will show that for every (closed) Branch Back program formula, there exists a semantically equivalent program control graph, and for every program control graph, there exists a semantically equivalent (closed) Branch Back program formula.
